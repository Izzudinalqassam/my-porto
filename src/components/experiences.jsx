...
import { MapPin, CheckSquare, Calendar, Briefcase, Award } from 'lucide-react';
import Icon from './ui/Icon';
import { LEVEL_COLORS, ANIMATION_CONFIG } from '../utils/constants.js';
import experiences from '../data/experiences.js';

// Enhanced timeline item component with better visualization
...
// Main experience component with enhanced header
const Experience = () => {
  return (
